...
export class UpdateAdvertisingScreen1694448892752
  implements MigrationInterface
{
  name = 'UpdateAdvertisingScreen1694448892752';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "Advertising" ADD CONSTRAINT "FK_0505dd9b71a14959152d58f941f" FOREIGN KEY ("imageTypeId") REFERENCES "AdvertisingType"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
