...
export class Data1696987083950 implements MigrationInterface {
  name = 'Data1696987083950';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "Screen" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "subscription" character varying(100) NOT NULL, "templeteId" character varying(100) NOT NULL, "courseIntervalTime" integer NOT NULL, "advertisingIntervalTime" integer NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "sectorId" integer, CONSTRAINT "PK_bf86825808b3babf300fad57b2f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "Advertising" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "name" character varying NOT NULL, "payload" character varying, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "advertisingTypeId" integer, "userId" integer, "sectorId" integer, CONSTRAINT "PK_2bcfc39a910f60618f47fabd427" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "AdvertisingSector" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "advertisingId" integer, "sectorId" integer, CONSTRAINT "PK_11ec8cc8f6856b34d312924c37e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "AdvertisingSector" ADD CONSTRAINT "FK_9fdb51a06c4390aac8c219ad825" FOREIGN KEY ("advertisingId") REFERENCES "Advertising"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "AdvertisingSector" ADD CONSTRAINT "FK_acbd4c9205396e60b3b4e91e2ff" FOREIGN KEY ("sectorId") REFERENCES "Sector"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "AdvertisingSector" DROP CONSTRAINT "FK_acbd4c9205396e60b3b4e91e2ff"`,
    );
    await queryRunner.query(
      `ALTER TABLE "AdvertisingSector" DROP CONSTRAINT "FK_9fdb51a06c4390aac8c219ad825"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`DROP TABLE "AdvertisingSector"`);
