...
export class CreateBaseDeDatos1694788236304 implements MigrationInterface {
  name = 'CreateBaseDeDatos1694788236304';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "Advertising" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "name" character varying NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "advertisingTypeId" integer, "userId" integer, "sectorId" integer, "scheduleId" integer, CONSTRAINT "PK_2bcfc39a910f60618f47fabd427" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
